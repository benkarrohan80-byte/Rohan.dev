...
import { addInquiry, syncInquiriesWithServer, updateInquiryStatus } from '../utils/inquiryStorage';
...
export default function Contact() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('open-create-website', handleOpenCreateWebsite);
  }, []);
