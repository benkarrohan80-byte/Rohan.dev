...
import { 
  ...
  subscribeInquiries,
  clearAllInquiriesFromFirestore
...
export default function AdminPanel({ onClose }: AdminPanelProps) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeInquiries((items) => {
      setInquiries(items);
    });
            ...
            >
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-4 text-left" autoComplete="off">
                <div className="space-y-1.5">
                  <label htmlFor="adm-usr-field" className="text-xs uppercase font-bold text-slate-400 tracking-wider">
                    Username
                  </label>
                  <input
                    type="text"
                    id="adm-usr-field"
                    name="adm_usr_field_nofill"
                    autoComplete="off"
                    autoCorrect="off"
                    autoCapitalize="none"
                    spellCheck={false}
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <label htmlFor="adm-pwd-field" className="text-xs uppercase font-bold text-slate-400 tracking-wider">
                      Password
                    </label>
                  </div>
                  <input
            ...
            <div className="flex-1 p-6 flex flex-col justify-between overflow-y-auto">
              {showPasswordChange ? (
                ...
                <div className="max-w-md mx-auto my-auto space-y-4 w-full bg-slate-950 p-6 rounded-2xl border border-slate-800">
                  ...
                  <form onSubmit={handlePasscodeChangeSubmit} className="space-y-4" autoComplete="off">
